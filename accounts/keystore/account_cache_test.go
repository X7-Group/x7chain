...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("x7c-keystore-watchnodir-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestUpdatedKeyfileContents(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("x7c-keystore-updatedkeyfilecontents-test-%d-%d", os.Getpid(), rand.Int()))
	ks := NewKeyStore(dir, LightScryptN, LightScryptP)
