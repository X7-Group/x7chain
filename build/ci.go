...
import (
	...
	"github.com/X7-Group/x7chain/crypto/signify"
	"github.com/X7-Group/x7chain/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/X7-Group/x7chain/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/X7-Group/x7chain/internal/version.gitDate="+env.Date)
	}
