...
import (
	...
	"github.com/X7-Group/x7chain/accounts/keystore"
	"github.com/X7-Group/x7chain/common"
	"github.com/X7-Group/x7chain/common/fdlimit"
	...
	x7c "github.com/X7-Group/x7chain/eth"
	"github.com/X7-Group/x7chain/eth/catalyst"
	"github.com/X7-Group/x7chain/eth/downloader"
	"github.com/X7-Group/x7chain/eth/ethconfig"
	"github.com/X7-Group/x7chain/eth/filters"
	"github.com/X7-Group/x7chain/eth/gasprice"
	"github.com/X7-Group/x7chain/eth/tracers"
	"github.com/X7-Group/x7chain/ethdb"
	"github.com/X7-Group/x7chain/ethdb/remotedb"
	"github.com/X7-Group/x7chain/ethstats"
	"github.com/X7-Group/x7chain/graphql"
	"github.com/X7-Group/x7chain/internal/ethapi"
	"github.com/X7-Group/x7chain/internal/flags"
	"github.com/X7-Group/x7chain/log"
	"github.com/X7-Group/x7chain/metrics"
	"github.com/X7-Group/x7chain/metrics/exp"
	"github.com/X7-Group/x7chain/metrics/influxdb"
	...
	"github.com/X7-Group/x7chain/p2p/nat"
	"github.com/X7-Group/x7chain/p2p/netutil"
	"github.com/X7-Group/x7chain/params"
	"github.com/X7-Group/x7chain/rpc"
	"github.com/X7-Group/x7chain/trie"
	"github.com/X7-Group/x7chain/trie/triedb/hashdb"
	"github.com/X7-Group/x7chain/trie/triedb/pathdb"
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "x7c", ethPeers, "total", cfg.MaxPeers)
...
func setRequiredBlocks(ctx *cli.Context, cfg *ethconfig.Config) {
	...
	if requiredBlocks == "" {
		if ctx.IsSet(LegacyWhitelistFlag.Name) {
			log.Warn("The flag --whitelist is deprecated and will be removed, please use --x7c.requiredblocks")
...
// SetEthConfig applies x7c-related command line flags to the config.
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *x7c.Ethereum) {
	backend, err := x7c.New(stack, cfg)
	if err != nil {
...
// RegisterFilterAPI adds the x7c log filtering RPC API to the node.
...
func RegisterFullSyncTester(stack *node.Node, x7c *x7c.Ethereum, target common.Hash) {
	catalyst.RegisterFullSyncTester(stack, x7c, target)
