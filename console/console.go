...
import (
	...
	"github.com/X7-Group/x7chain/internal/jsre"
	"github.com/X7-Group/x7chain/internal/jsre/deps"
	"github.com/X7-Group/x7chain/internal/web3ext"
...
var defaultAPIs = map[string]string{"x7c": "1.0", "net": "1.0", "debug": "1.0"}
...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines x7c.getBalance(x7c.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
...
func (c *Console) Welcome() {
	...
	if res, err := c.jsre.Run(`
		...
		try {
			message += "coinbase: " + x7c.coinbase + "\n";
		} catch (err) {}
		message += "at block: " + x7c.blockNumber + " (" + new Date(1000 * x7c.getBlock(x7c.blockNumber).timestamp) + ")\n";
		try {
