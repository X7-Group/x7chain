...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *x7c.Response) (*x7c.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *x7c.Response) (int, error) {
	txs, uncles, withdrawals := packet.Res.(*x7c.BlockBodiesResponse).Unpack()
