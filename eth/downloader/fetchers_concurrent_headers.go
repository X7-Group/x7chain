...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *x7c.Response) (*x7c.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *x7c.Response) (int, error) {
	headers := *packet.Res.(*x7c.BlockHeadersRequest)
