...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *x7c.Response) (*x7c.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *x7c.Response) (int, error) {
	receipts := *packet.Res.(*x7c.ReceiptsResponse)
