...
import "github.com/X7-Group/x7chain/metrics"
...
func init() {
	meters = bidirectionalMeters{
		ingress: newHandshakeMeters("x7c/protocols/x7c/ingress/handshake/"),
		egress:  newHandshakeMeters("x7c/protocols/x7c/egress/handshake/"),
	}
}
