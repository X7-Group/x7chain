...
// ProtocolName is the official short name of the `x7c` protocol used during
// devp2p capability negotiation.
const ProtocolName = "x7c"

// ProtocolVersions are the supported versions of the `x7c` protocol (first
// is primary).
...
// Packet represents a p2p message in the `x7c` protocol.
...
// NewPooledTransactionHashesPacket67 represents a transaction announcement packet on x7c/67.
type NewPooledTransactionHashesPacket67 []common.Hash

// NewPooledTransactionHashesPacket68 represents a transaction announcement packet on x7c/68 and newer.
