...
coverpkg="github.com/X7-Group/x7chain/..."
...
repo=$GOPATH/src/github.com/X7-Group/x7chain
compile_fuzzer github.com/X7-Group/x7chain/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/X7-Group/x7chain/common/bitutil \
...
compile_fuzzer github.com/X7-Group/x7chain/eth/protocols/snap \
  FuzzARange fuzz_account_range \
  $repo/x7c/protocols/snap/handler_fuzzing_test.go
...
compile_fuzzer github.com/X7-Group/x7chain/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/X7-Group/x7chain/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/X7-Group/x7chain/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/X7-Group/x7chain/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
